...
cells = [
    ...
    # ── 4. Génération des labels optimaux ────────────────────────────────────
    {
        "cell_type": "markdown", "metadata": {},
        "source": [
    ...
    # ── 5. Construction des paires (patient, hôpital) ───────────────────────
    {
        "cell_type": "markdown", "metadata": {},
        "source": [
...
with open("dnn_patient_allocation.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2, ensure_ascii=False)

print("Notebook 'dnn_patient_allocation.ipynb' créé avec succès !")
